  ...
  return (
    <section id="about" className="container-px py-20 sm:py-28">
      <div className="grid grid-cols-1 gap-10 md:grid-cols-3 md:gap-8 lg:gap-12">
        <div>
          <p className="section-eyebrow text-ink-soft">About Saqib</p>
      ...
      <div className="mt-16 grid grid-cols-1 gap-3 border-t border-line pt-6 text-[0.7rem] uppercase tracking-[0.16em] text-ink-soft sm:grid-cols-3 sm:text-center">
